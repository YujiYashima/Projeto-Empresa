...
public class CadastrarTipo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            TipoPessoaJuridica tipo = new TipoPessoaJuridica();
            tipo.setNomeTipoPessoaJuridica(nomeTipo);
            
            try {
                GenericDAO tipoPessoaJuridicaDAO = new TipoPessoaJuridicaDAO();
                if (tipoPessoaJuridicaDAO.cadastrar(tipo)) {
                ...
                System.out.println("Problemas ao cadastrar Tipo CTR! Erro: " + ex.getMessage());
                ex.printStackTrace();
            }
